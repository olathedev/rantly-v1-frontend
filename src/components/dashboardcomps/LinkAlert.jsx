...
`
  ...
  return (
    <div>
      <div className="alert bg-black bg-opacity-70 rounded-lg py-6 px-4 md:px-8 font-rale w-full">
        ...
        <div className='flex items-center gap-2 bg-white'>
          ...
          <button onClick={() => copyToClipBoard(url)} className='bg-primary text-white p-2 rounded' disabled={copied}>
            {!copied ? (
