...
function LinkAlert({ user }) {
  ...
  return (
    <div>
      <div className="alert bg-primary bg-opacity-25 rounded-lg py-6 px-4 md:px-8 font-rale w-full">
        
        <div className='flex items-center gap-2 bg-white'>
        <div className="text-center font-rale font-semibold p-2 rounded cursor-pointer text-slate-950 bg-opacity-40">
          rantly.vercel.app/r/{user.username}
        </div>


          <div onClick={() => copyToClipBoard("rantly.vercel.app/oladev01")} className='bg-slate-950 text-white p-2 rounded'>
