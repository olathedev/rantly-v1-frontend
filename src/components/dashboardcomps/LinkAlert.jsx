...
`
  ...
  return (
    <div>
      <div className="container alert bg-black rounded-lg py-6 px-2 md:px-8 font-rale w-full">

        <div className='flex flex-wrap items-center gap-2  justify-center rounded'>
          <div className="text-center font-rale font-semibold p-2 rounded cursor-pointer text-black bg-opacity-90 bg-white">
            {url}
            </div>
        ...
        <div className="flex flex-col py-3 w-full">
          ...
          <div className="py-2 px-3 flex gap-3 justify-center items-center">
           <a href={`whatsapp://send?text=I've got an anonymous inbox open just for you! 🕵️‍♂️✉️ Click the link and share your thoughts, i wont know who sent it. ${url}`}><img src={social1} className='h-10' alt="" /></a>
           <img src={social} className='h-10' alt=""  onClick={shareOnFacebook} />
            <img src={social2} className='h-10' alt="" />
