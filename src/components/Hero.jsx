    ...
    <div className='container px-6 mx-auto flex flex-col items-center md:px-10 mt-4 md:mt-10 lg:flex-row lg:justify-between lg:text-start'>
        <div className="pt-10 lg:w-2/3 flex-col gap-4">
            ...
            <div className='flex items-center mt-10 gap-2 md:gap-3 lg:justify-start'>
             ...
             <Link to='dashboard/user'> <button className="bg-primary text-white text-lg font-pop py-2 px-5 md:py-3 md:px-5 rounded-lg">Start Ranting</button> </Link>
               
             <Link to='dashboard/user'> <button className="bg-gray-200 font-pop text-lg  py-2 px-5 md:py-3 md:px-5 rounded-lg">Developer</button> </Link>
