  ...
  return (
    <div className='container px-6 mx-auto flex flex-col-reverse text-center md:px-10 mt-4 md:mt-10 md:flex-row md:justify-between md:text-start '>
        <div className="pt-10 md:w-1/2 md:pt-20 flex-col gap-4">
            ...
            <div className='font-pop md:w-2/3 mt-8 text-lg text-gray-800 font-semibold'> Rantly is Sleek and <span className="font-bold">Super Easy to use</span>. Create an account, share link with friends and start getting anonymous rants on the go </div>
