  ...
  return (
    <div className='navbar'>
        <div className="hidden container my-6 mx-auto md:flex justify-between items-center md:px-10">
            ...
            <Link to='/' className='navbar-brand text-3xl font-ws font-semibold text-gray-900'>Rantly</Link>

            <div className='nav-links flex gap-5 text-xl font-mont items-center font-semibold text-gray-700 cursor-pointer'>
